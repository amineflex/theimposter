...
import { t } from '@/i18n'
import type { GameDescriptionRow } from '@/games/the-imposter/types/db'
 ...
 */
export function DescriptionInput({ room }: { room: ImposterRoom }) {
  const { play } = useSound()
...
export function useDescriptionEntries(room: ImposterRoom): DescriptionEntry[] {
